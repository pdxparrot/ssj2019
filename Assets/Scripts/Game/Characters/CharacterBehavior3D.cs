...
namespace pdxpartyparrot.Game.Characters
{
    public abstract class CharacterBehavior3D : ActorBehavior3D
    {
        ...
        public CharacterBehaviorData3D CharacterBehaviorData => (CharacterBehaviorData3D)BehaviorData;

        [SerializeField]
        private CharacterBehaviorComponent3D.ReorderableList _components = new CharacterBehaviorComponent3D.ReorderableList();
...
#region Unity Lifecycle
        ...
        {
            Assert.IsTrue(behaviorData is CharacterBehaviorData3D);
...
#region Components
        ...
        {
            foreach(CharacterBehaviorComponent3D component in _components.Items) {
                if(f(component)) {
                    return;
                }
            }
